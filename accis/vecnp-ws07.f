...
c g77 is incapable of handling non-printable characters properly.
      ...
      data ca(00056:00097)/'/SP0  { 8 setlinewidth 1.000 1.000 1.000 s'/
      data ca(00098:00113)/'etrgbcolor } def'/
      data ca(00114:00115)/crlf/
      data ca(00116:00157)/'/SP1  { 8 setlinewidth 0.000 0.000 0.545 s'/
      data ca(00158:00173)/'etrgbcolor } def'/
      data ca(00174:00175)/crlf/
      data ca(00176:00217)/'/SP2  { 8 setlinewidth 0.180 0.545 0.341 s'/
      data ca(00218:00233)/'etrgbcolor } def'/
      data ca(00234:00235)/crlf/
      data ca(00236:00277)/'/SP3  { 8 setlinewidth 0.125 0.698 0.667 s'/
      data ca(00278:00293)/'etrgbcolor } def'/
      data ca(00294:00295)/crlf/
      data ca(00296:00337)/'/SP4  { 8 setlinewidth 0.698 0.133 0.133 s'/
      data ca(00338:00353)/'etrgbcolor } def'/
      data ca(00354:00355)/crlf/
      data ca(00356:00397)/'/SP5  { 8 setlinewidth 0.580 0.000 0.827 s'/
      data ca(00398:00413)/'etrgbcolor } def'/
      data ca(00414:00415)/crlf/
      data ca(00416:00457)/'/SP6  { 8 setlinewidth 0.957 0.643 0.376 s'/
      data ca(00458:00473)/'etrgbcolor } def'/
      data ca(00474:00475)/crlf/
      data ca(00476:00517)/'/SP7  { 8 setlinewidth 0.439 0.502 0.565 s'/
      data ca(00518:00533)/'etrgbcolor } def'/
      data ca(00534:00535)/crlf/
      data ca(00536:00577)/'/SP8  { 8 setlinewidth 0.745 0.745 0.745 s'/
      data ca(00578:00593)/'etrgbcolor } def'/
      data ca(00594:00595)/crlf/
      data ca(00596:00637)/'/SP9  { 8 setlinewidth 0.000 0.000 1.000 s'/
      data ca(00638:00653)/'etrgbcolor } def'/
      data ca(00654:00655)/crlf/
      data ca(00656:00697)/'/SP10 { 8 setlinewidth 0.000 1.000 0.000 s'/
      data ca(00698:00713)/'etrgbcolor } def'/
      data ca(00714:00715)/crlf/
      data ca(00716:00757)/'/SP11 { 8 setlinewidth 0.000 1.000 1.000 s'/
      data ca(00758:00773)/'etrgbcolor } def'/
      data ca(00774:00775)/crlf/
      data ca(00776:00817)/'/SP12 { 8 setlinewidth 1.000 0.000 0.000 s'/
      data ca(00818:00833)/'etrgbcolor } def'/
      data ca(00834:00835)/crlf/
      data ca(00836:00877)/'/SP13 { 8 setlinewidth 1.000 0.000 1.000 s'/
      data ca(00878:00893)/'etrgbcolor } def'/
      data ca(00894:00895)/crlf/
      data ca(00896:00937)/'/SP14 { 8 setlinewidth 1.000 1.000 0.000 s'/
      ...
      data ca(01435:01476)/'/SP15 { 8 setlinewidth 0.000 0.000 0.000 s'/
      data ca(01477:01492)/'etrgbcolor } def'/
      data ca(01493:01494)/crlf/
      data ca(01495:01536)/'gsave 1 setlinecap 1 setlinejoin  72 1016 '/
      data ca(01537:01567)/'div dup scale 426 426 translate'/
      data ca(01568:01569)/crlf/
      data ca(01570:01582)/'SP15 0 0 MT '/
