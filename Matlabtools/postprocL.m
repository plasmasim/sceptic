...
% postprocL(folder)
% Outputs diagnostics as a function of \lambda_{De} for the files included in
% the file "titles" in the folder "folder"
    ...
    clear B V L K v Fc Fo Ffield Felec Fion Ftot Felec2 Fion2 Ffield2 Ftot2 fluxtot;
        figure;
        hold all
    ...
    % sort
    BF=[L',fluxtot',K',V',Ffield',Felec',Fion',Ftot',Ffield2',Felec2',Fion2',Fcoll2',Ftot2'];
    BF=sortrows(BF,1);

    figure(1)
    plot(BF(:,1),BF(:,2))
    title('Ion Current','FontSize',18)
    xlabel('\lambda_{De}','FontSize',18)
